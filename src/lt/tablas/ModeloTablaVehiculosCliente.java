...
public class ModeloTablaVehiculosCliente extends AbstractTableModel {

    private String[] columnas = {"Marca", "Modelo", "Matricula", "Año"};
    ...
    public void setLista(List<Vehiculo> vehiculos) {
        ...
        for (int i = 0; i < vehiculos.size(); i++) {
            ...
            datos[i][3] = vehiculos.get(i).getAnho();
            //datos[i][4] = tipoPlan.getNombrePlan();
